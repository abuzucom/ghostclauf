...
before checking length, since that suffix is not user-authored. Merge commits
are skipped because their subjects are generated by Git. Cannot verify
imperative mood, only shape. Blocking: exits 1 on any violation.
"""
import argparse
import re
import subprocess
