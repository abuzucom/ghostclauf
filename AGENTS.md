...
Not currently enforced by CI in this repo; platform-level bot blocks apply separately. A mechanical check (matching commit author, committer, and `Co-authored-by` trailer fields, plus the PR author, against a denylist) is proposed but not yet added; see Rule 13.
