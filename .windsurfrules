...
ghostclauf is a plugin-based Twitch chat bot. Commands, protected paths, the
plugin contract, and the public-site boundary live in
`docs/agent-orientation.md`. Read it before editing.
<!-- repository-only:end -->
